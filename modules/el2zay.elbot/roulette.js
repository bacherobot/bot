...
module.exports = {
	...
	async execute(interaction) {
		...
		// frr j'ai vu le code j'me suis pas senti capable de le rendre propre vrm j'ai passé eslint puis j'suis parti

		if (interaction.options.getString("cadeau").toLowerCase() == "rien") return interaction.editReply({ content: "T'es radin toi, comment ça rien", ephemeral: true }).catch(err => {})
