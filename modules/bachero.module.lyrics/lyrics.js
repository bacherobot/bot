...
module.exports = {
	...
	async execute(interaction){
		...
		.setFooter({ text: `Paroles récupérées via Genius sous la demande de ${interaction.user.discriminator == '0' ? escape(interaction.user.username) : escape(interaction.user.tag)}` })
